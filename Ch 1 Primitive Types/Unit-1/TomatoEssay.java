public class TomatoEssay
{
    public static void main(String[] args)
    {
        ...
        System.out.println(" ruled that tomatoes should be classified as a vegetable under U.S Customs regulations because they are consumed more like a vegetable than a fruit, and should be taxed as such.");
